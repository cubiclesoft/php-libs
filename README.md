...
* SystemProfile - Static functions in a class to generate an array of internal device hardware information for the current device.  [Documentation](https://github.com/cubiclesoft/php-misc/blob/master/docs/system_profile.md)  (support/system_profile.php)
